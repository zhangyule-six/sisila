...
export const FormItem = (props) => {
    const { label, children, name, rules, valuePropName = "value", trigger = "onChange", validateTrigger = "onBlur", getValueFromEvent = (e) => e.target.value, } = props;
    const { dispatch, fields, initialValues, validateField } = useContext(FormContext);
    const rowClass = classNames("sisila-row", {
        "sisila-row-no-label": !label,
    });
    useEffect(() => {
    ...
    const labelClass = classNames({
        "sisila-form-item-required": isRequired,
    });
    const itemClass = classNames("sisila-form-item-control", {
        "sisila-form-item-has-error": hasError,
    });
    ...
    return (React.createElement("div", { className: rowClass },
        label && (React.createElement("div", { className: "sisila-form-item-label" },
            React.createElement("label", { title: label, className: labelClass }, label))),
        React.createElement("div", { className: "sisila-form-item" },
            React.createElement("div", { className: itemClass }, returnChildNode),
            hasError && (React.createElement("div", { className: "sisila-form-item-explain" },
